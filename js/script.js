...
Iya.addEventListener("click", function () {
    ...
    if (Iya.value == 1) {
        ...
        Text.innerHTML = "Hai... <br> Saya Rizka Ma'rifatul Khasanah";
        Text.classList.add('text-animate');
    }else if (Iya.value == 2) {
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        Text.innerHTML = "Remember when brainly said: <br> 'maaf kalo salah'";
        ...
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        Text.innerHTML = "Di hari fitri ini <br> mohon maaf lahir dan batin";
        Text.classList.add('text-animate');
    }else if (Iya.value == 7) {
